# ====================================================================================
#  Blender Production Manager — Fusión de Tree Builder + Overseer
#  Versión fusionada: 2.5.8
#  Autor: David Rodríguez (Fusionado por Gemini)
#
#  Este script combina dos addons en uno solo:
#  1. BPM - Overseer: Panel de supervisión de assets mediante CSV.
#  2. BPM - Tree Builder: Creador de estructura de carpetas de proyecto.
#
#  Modificaciones según feedback:
#  - Eliminada la fila de cabecera estática del panel Overseer.
#  - Revertido todo el texto de la UI y los reportes al inglés original.
# ====================================================================================

bl_info = {
    "name"        : "Blender Production Manager — Tree Builder + Overseer",
    "author"      : "David Rodríguez (Fusionado por Gemini)",
    "version"     : (2, 5, 8),
    "blender"     : (4, 0, 0),
...
# ====================================================================================
#  OPERATOR  •  PLANT THE TREE (from Tree Builder)
# ====================================================================================
